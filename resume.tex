	...
	\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
		...
		\begin{description}
			...
			{	
				\footnotesize
				\begin{itemize}
					\resitem{Enabled more flexible and efficient user workflows through designing and implementing conflict-free, eventually-consistent, real-time replication infrastructure, client services, and developer SDKs (Go, FoundationDB, Kubernetes, NixOS)}
					\resitem{Built real-time messaging system to seamlessly interface and communicate with multiple military data links and communication systems (Go, Kubernetes)}
