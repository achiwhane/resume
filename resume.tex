...
\newcommand{\mywebheader}{
	\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
		...
		\begin{description}
			...
			{Software Engineer -- Platform Infrastructure (Live Data Systems team)}{May 2021 -- Present}
			{	
				\footnotesize
				\begin{itemize}
			...
			\item
			\ressubheadingmult{DRW}{Chicago, IL}
			{Senior Software Engineer -- Risk Management}{January 2021 -- April 2021}
			{Software Engineer -- Risk Management}{April 2019 -- January 2021}
			{	
				\footnotesize
				\begin{itemize}
